...
//Questão 1 - C (Funçao de ativação puramente linear)
clear;
clc;
lines(0);
...
Qco = 2; //quantidade de neuronios na camada oculta
Qcs = 1; //quantidade de neuronios na camada de saida
interacoes_geral = 5000;//numero total de interações da rede
erro = 0.0000001;// Erro a ser enconrado pela rede
...
//----------------Implementação da retropropagação-----------------------------------------------------------------------------
 ...
 //----------------Impressão do Gráfico--------------------------------------------------------------------------------------------
  ...
  printf("Interação [%d] = %f\n",interacoes,erroQ);
    ...
    plot2d(vetorcontrole, vetorerroepoca); 
